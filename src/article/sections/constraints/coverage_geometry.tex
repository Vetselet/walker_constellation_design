\subsection{Coverage Geometry and Orbital Plane Spacing}
...
The field-of-view half-angle may be specified directly by the payload characteristics
or determined from the link budget as described in Subsection~\ref{subsec:snr}.
...
\paragraph{Sattelite coverage geometry}
...
\label{eq:effective_fov}
\end{equation}

\paragraph{Street-of-coverage}
...
\paragraph{Angular separation between orbital planes}
